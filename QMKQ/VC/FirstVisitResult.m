...
@interface FirstVisitResult () <UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;

@property (nonatomic, strong) NSDictionary * tooth;
@end

@implementation FirstVisitResult
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    else if (section == 3) title = @"照片:";
    CaseHeaderView*view=[tableView dequeueReusableHeaderFooterViewWithIdentifier:@"firstVisitResultHeader"];
    if (!view) {
        view = [[CaseHeaderView alloc]initWithReuseIdentifier:@"firstVisitResultHeader"];
    }
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    else if (section == 1) number = 11;
    else if (section == 2) number = 14;
    else if (section == 3) number = 6;
    return number;
}
    ...
    if (section == 0) {
        ...
        if (row <= 10) {
            ...
            switch (row) {
                case 0: {
                    cel.left.text = @"口腔卫生";
                    NSInteger t = [[self.caseResult objectForKey:@"mouth_hygiene"] intValue];
                    if (t == 0) {
                        cel.right.text = @"好";
                    }else if (t==1) {
                        cel.right.text = @"中";
                ...
                case 1: {
                    cel.left.text = @"牙周";
                    cel.right.text = [self.caseResult objectForKey:@"yaZhouYan"];
                }break;
                case 2: {
                    cel.left.text = @"磨牙关系";
        ...
        if (row == 0) {
            ...
            [cel.firstImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"zhengMianXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.secondImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"ceMianXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.thirdImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"weiXiaoXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            ...
            [cel.firstImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"zhengMianKouNeiXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.secondImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"ceWeiXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            ...
            [cel.firstImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"shangHeWeiXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.secondImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"xiaHeWeiXiang"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            ...
            [cel.firstImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"xRayPicUrl0"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.secondImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"xRayPicUrl1"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.thirdImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"xRayPicUrl2"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
            [cel.lastImgView setImageWithURL:[NSURL URLWithString:[self getSmallImage:[dic objectForKey:@"xRayPicUrl3"]]] placeholderImage:[UIImage imageNamed:@"zp"]];
...
- (NSString*)getSmallImage:(id)item
{
    return [Tools imageFromString:item withSuffix:@"_small"];
}
